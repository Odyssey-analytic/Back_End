...
from .consumers import KPI_Monitor, AverageSessionLength_Monitor, GameEventSSEConsumer, DailyActiveUsersConsumer, AverageFPSConsumer, AverageMemoryUsageConsumer, AverageSessionDurationConsumer, TotalRevenuePerCurrencyConsumer, ARPPUConsumer, LevelCompletionRateConsumer, AverageTriesPerLevelConsumer, NetResourceFlowConsumer, CrashRateConsumer, ResourceSinkRatioConsumer, TopErrorTypesConsumer
...
sse_urlpatterns = [
    ...
    re_path(r"^kpi/sse/ARPPU$", ARPPUConsumer.as_asgi()),
